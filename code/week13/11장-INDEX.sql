...
-- 릴레이션 스키마 
	강사 (강사번호(PK), 이름, 전문 분야, 연락처)
	강좌 (강좌번호(PK), 강좌명, 수강료, 최대인원, 강좌번호(FK))
...
SELECT * FROM members2
where name = '홍길동';
--Planning Time: 3.709 ms (without index 1.934 ms,)
--Execution Time: 0.209 ms (without index 9.930 ms)
